...
def main(args):
    ...
    data = build_data_loaders(dev_data, batch_size=args.batch_size, num_workers=0,
                              shuffle=False, batches_per_epoch=args.updates_per_epoch)
    # for i in data:
    #     print(i)
    ...
    # for _train_data in train_data.values():
    #     _train_data.index_with(vocab)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--confidence',
                        help='confidence of keep',
                        default=0,
                        type=float)
    parser.add_argument('--weight_path',
                        help='the class weight file',
                        default=None)
